...
const ProductListPage = () => {
  ...
  <div className="container mx-auto flex">
    {/** Subcategory Sidebar (Fixed Width) **/}
    <div className="sticky top-20 w-[200px] md:w-[280px] min-h-[88vh] max-h-[88vh] 
        overflow-y-scroll grid gap-1 shadow-md scrollbarCustom bg-white py-2">
